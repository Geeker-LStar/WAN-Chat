    ...
    <body>
        ...
        <?php
            ...
            if (file_exists("headimg/" . $wid . ".png"))
                echo "<img src='headimg/$wid.png?timestamp=$time' style='height: 100px; width: 100px;'><br><br>";
            else
                echo "<img src='headimg/wan-default-head.png' style='height: 100px; width: 100px;'><br><br>";
            echo "<button class='btn btn-primary' onclick='window.location.href=\"headimg.php\";'>设置和修改头像</button><br><br>";
            echo "手机号：" . $phone;
        ...
        <?php 
            ...
            else
            {
                ...
                {  
                    ...
                    echo "<span style='color: skyblue;'>（{$gn}）</span><h4 style='display: inline-block;'>{$gname}</h4><b>{$who_shown}</b><span class='short'>说：{$msg}</span><br>";
                }
